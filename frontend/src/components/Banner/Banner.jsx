...
const Banner = () => {
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        console.log('Searching for :', searchQuary);
    }
                ...
                <div className=' max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10'>
                    ...
                    <div className=' flex-1 space-y-8 relative md:pr-8 lg:pr-19 text-center md:text-left'>
                        ...
                        <p className='text-lg md:text-lg lg:text-xl font-playfair italic sm:text-xl text-amber-100 max-w-xl opacity-90 mx-auto md:mx-0'>
                            Best Cooks and Best Delivery Guys all at your Service. Hot Testy food Will Reach You in 60 minutes.
                        </p>
                        ...
                        shadow-2xl hover:bg-amber-400/50 transition-all duration-300'>
                                ...
                                <button type='submit' className='mr-4 px-6 py-3 bg-gradient-to-r from-amber-400 to-amber-300 rounded-lg font-semibold text-amber-900
                             hover:from-amber-300 hover:to-amber-200 transition-all duration-300 shadow-lg hover:shadow-amber-300/20'>
                                    Search
                                </button>
                            </div>
                        </form>
                        ...
                        py-3 rounded-xl transition-all duration-300 border-2 border-amber-700/50 hover:border-amber-400 backdrop-blur-sm'>
                            ...
                            <button onClick={() => setShowVideo(true)} className=' group flex items-center gap-3 bg-gradient-to-r from-amber-400 to-amber-300 hover:from-amber-300 hover:to-amber-200 px-6 py-3
                            rounded-xl transition-all duration-300 shadow-lg hover:shadow-amber-300/30'>
                    ...
                    <div className='flex-1 relative group mt-8 md:mt-0 min-h-[300px] sm:min-h-[400px]'>
                        ...
                        {orbitImages.map((imgSrc, index) => (
                            ...
                            w-[80px] xs:w-[100px] sm:w-[150px] h-[80px] xs:h-[100px] sm:h-[150px]`}>
                                ...
                                className='w-full h-full rounded-full border  border-amber-500/30 shadow-lg bg-amber-900/20 object-cover' />
                            </div>
                        ))}
                    </div>
