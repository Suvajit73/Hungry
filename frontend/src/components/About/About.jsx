...
import { m, motion, scale } from 'framer-motion'
            ...
            <motion.section initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }}
                ...
                <div className='max-w-4xl mx-auto'>
                    ...
                    <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                        Indulge in restaurant-quality dining, freshly crafted and delivered to your door.
                    </motion.p>
                </div>
            </motion.section>
                        ...
                        return (
                            <motion.div key={s.label} initial={{ opacity: 0, y: 50 }}
                                ...
                                <motion.div className='absolute inset-0' animate={{
                                    ...
                                    <div className='relative h-full bg-[#3c2a21]/40 backdrop-blur-lg rounded-xl
                                                    border-2 border-amber-600/30 p-6 overflow-hidden transition-all duration-300'>
