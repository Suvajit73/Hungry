...
const MyOrder = () => {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        const response = await axios.get('https://hungry-backend-jomb.onrender.com/api/orders', {
                      ...
                      transition-colors group'>
                          ...
                          <div className='space-y-2'>
                            {order.items.map((item, index) => (
                              ...
                              className='flex items-center gap-3 p-2 bg-[#3a2b2b]/50 rounded-lg'>
                                <img src={`https://hungry-backend-jomb.onrender.com${item.item.imageUrl}`} alt={item.item.name} 
                        ...
                        <td className='p-4'>
                          <div className='flex flex-col gap-2'>
                            ...
                            <div className={`${paymentMethod.color} px-3 py-1.5 rounded-lg
                            text-sm`}>
                              {paymentMethod.icon}
