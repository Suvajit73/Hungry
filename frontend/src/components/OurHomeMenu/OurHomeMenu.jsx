...
import './OurHomeMenu.css'; // Assuming you have a CSS file for additional styles
    ...
    return (
        <div className='bg-gradient-to-br from-[#1a120b] via-[#2a1e14] to-[#3e2b1d] min-h-screen py-16 px-4 sm:px-6 lg:px-8'>
            ...
            bg-gradient-to-r from-amber-200 via-amber-300 to-amber-200'>
                    <span className='font-dancingcript block text-5xl md:text-7xl sm:text-6xl mb-2'>
                        Our Exquisite Menu
                    </span>
                                            ...
                                            {qty > 0 ?(
                                                <>
                                                    <button className=' w-8 h-8 rounded-full bg-amber-900/40 flex items-center justify-center hover:bg-amber-800/50 transition-colors'
                                                         onClick={() => qty > 1 ? updateQuantity(cartEntry._id, qty - 1) : removeFromCart(cartEntry._id)}>
                                                ...
                                                <button onClick={() => addToCart(item,1)} className='bg-amber-900/40 px-2.5 py-1.5 rounded-full font-cinzel text-xs uppercase sm:text-sm tracking-wider transition-transform duration-300
