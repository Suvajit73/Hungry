...
const AboutHome = () => {
    return (
        <div className='min-h-screen bg-gradient-to-br from-[#0f0a0a] via-[#1a1212] to-[#1a1212] text-white
            ...
            <div className='absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none'>
                ...
                <div className='absolute bottum-0 right-0 w-80 h-80 bg-orange-600/10 rounded-full blur-3xl mix-blend-soft-light' />
            </div>
            ...
            <div className='container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:gap-8 xl:gap-16 relative'>
                <div className='w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative'>
                    <div className='space-y-4 sm:space-y-8 px-4 sm:px-0'>
                        <h2 className='text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold leading-tight'>
                            <span className='font-cursive text-4xl sm:text-5xl md:text-6xl bg-gradient-to-r from-amber-400
                            ...
                            <span className=' inline-block mt-2 sm:mt-4 text-2xl sm:text-3xl md:text-4xl opacity-90 font-light'>
                                Where Flavors Dance &amp; Memorise Bloom
                            </span>
                        </h2>
                        ...
                        italic border-l-4 bg-amber-500/60 pl-4 sm:pl-6 py-2 bg-gradient-to-r from-white/5 to-transparent'>
                            "In our kitchen, every ingredient whispers freshness and every dish radiates warmth. We don’t 
                            just serve food – we create moments of joy, blending flavours 
                            that touch your soul and crafting experiences you’ll cherish long after the meal ends."
                        </p>
                    </div>
                    ...
                    <div className='flex flex-wrap gap-4 items-center mt-6 sm:mt-8 px-4 sm:px-0'>
                        ...
                        shadow-xl hover:shadow-amber-500/20 group relative overflow-hidden'>
                            <span className='absolute inset-0 bg-gradient-to-r from-amber-600/30 to-transparent opacity-0
                ...
                group transform hover:scale-[1.01] transition-all duration-500'>
                    ...
                    duration-500 shadow-2xl shadow-black/50'>
                        ...
                        <img src={AboutImage} alt="Restaurent" className='w-full h-auto object-cover aspect-[3/4] transform -rotate-1 hover:rotate-0 transition-all duration-500' />

                        <div className='absolute -bottom-12 left-1/2 -translate-x-1/2 w-4/5 h-1/6 bg-amber-900/30 blur-3xl z-0'/>
                    </div>
