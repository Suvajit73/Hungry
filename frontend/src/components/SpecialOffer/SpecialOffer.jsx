            ...
            <div className='max-w-7xl mx-auto'>
                ...
                to-red-500 bg-clip-text text-transparent font-[Playfair_Display] italic'>
                    ...
                    <p className='text-lg text-gray-300 max-w-3xl mx-auto tracking-wide leading-relaxed'>
                        Servor the extraordinary with our exclusive offers.
                    </p>
                </div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8'>
                    {displayList.map(item => {
                        ...
                        return (
                            <div key={item._id} className='relative group bg-[#4b3b3b] rounded-3xl
                        ...
                        hover:shadow-red-900/40 border-2 border-transparent hover:border-amber-500/20 before:absolute before:inset-0 hover:before:opacity-20'>
                                ...
                                brightness-90 group-hover:brightness-110 transition-all duration-500' />
                                    ...
                                    <div className='absolute bottom-4 left-4 right-4 flex justify-between items-center
                                         bg-black/40 backdrop-blur-sm px-4 pr-2 rounded-full'>
                ...
                <div className='mt-12 flex justify-center'>
                    <button onClick={() => setShowAll(!showAll)}
                        ...
                        hover:shadow-xl hover:shadow-amber-500/20 transition-all duration-300 group border-2 border-amber-400/30 relative overflow-hidden'>
