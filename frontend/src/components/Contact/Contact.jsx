...
const Contact = () => {
    ...
    return (
        <div className='min-h-screen bg-gradient-to-r from-orange-900 via-amber-900 to-gray-900 
    animate-gradient-x py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 font[Poppins] relative overflow-hidden'>
            ...
            <div className='max-w-7xl mx-auto relative z-10'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                    ...
                    <div className='space-y-6'>
                        <div className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-transform 
                        ...
                        duration-300 hover:scale-[1.02] animate-card-float border-l-4 border-green-500 hover:border-green-400 group'>
                            ...
                            <div className='pl-12 relative space-y-2 z-10'>
                                <p className='text-amber-100 font-light flex text-center'>
                        ...
                        <div className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-transform 
                        duration-300 hover:scale-[1.02] animate-card-float border-l-4 border-orange-500 hover:border-amber-400 group'>
                    ...
                    <div className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl animate-slide-in-right border-2
                        ...
                        <form onSubmit={handleSubmit} className='space-y-6 relative z-10'>
                                ...
                                <div key={name}>
                                    ...
                                    <div className='relative'>
                                        ...
                                        <input type={type} value={formData[name]} name={name} onChange={handleChange}
                                            className='w-full pl-10 pr-4 py-3 bg-white/10 border-2 border-amber-500/30 rounded-xl text-amber-50
                                            focus:ring-2 focus:ring-amber-500 focus:border-transparent placeholder-amber-200/50'
                            ...
                            <button type='submit' className='w-full bg-gradient-to-r from-amber-600 hover:from-amber-700 hover:to-orange-700 text-white font-semibold py-3 ppx6
                                    rounded-xl transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-amber-500/20 flex items-center justify-center space-x-2 group'>
